...
(function() {
  $(function() {
    var buttonValues, countConvert, initStuff, modifier, potatoCount, potatoGet, potatoTick, potatoUpgrades, roundToTwo, showDict, uiUpdate, upgradeCooficients, upgradeCosts, upgradeCostsN, upgradeInsert, upgradeNumbers, upgradeTypes;
    potatoCount = 0;
    potatoUpgrades = {};
    upgradeCooficients = {};
    upgradeCosts = {};
