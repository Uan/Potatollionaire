...
(function() {
  var Achievement, Building, Spell, SummonGolem, Upgrade, achievementCheck, achievements, activeSpells, buildingInsert, buildings, clickValue, cmTime, copyMachine, initMagic, initStuff, initUpgrades, magicMultiplier, mana, modifier, numberShortener, potatoCount, potatoGet, potatoTick, round, sacrifice, spells, tickNum, totalClicks, upgrades,
  ...
  initMagic = function() {
    return spells["golem"] = new SummonGolem;
  };
