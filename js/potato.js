...
(function() {
  ...
  $(function() {
    var activeSpells, buttonValues, copyMachine, countConvert, displayUpgrade, initStuff, magicMultiplier, mana, modifier, potatoCount, potatoGet, potatoTick, potatoUpgrades, roundToTwo, showDict, spells, tickNum, uiUpdate, upgradeCooficients, upgradeCosts, upgradeCostsN, upgradeInsert, upgradeNumbers, upgradeTypes;
    tickNum = 0;
    potatoCount = 0;
    potatoUpgrades = {};
    upgradeCooficients = {};
